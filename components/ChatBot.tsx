...
export function ChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: 'Hello! 👋 I\'m here to help you learn about Indian Studies. What would you like to know?',
      sender: 'bot',
      timestamp: new Date(),
    },
  ])
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-40 w-96 h-[600px] bg-white dark:bg-slate-900 rounded-lg shadow-2xl flex flex-col overflow-hidden border border-gray-200 dark:border-slate-700">
          {/* Header */}
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-4 text-white">
            <h3 className="font-bold text-lg">Indian Studies Assistant</h3>
            <p className="text-sm opacity-90">Ask me anything about Indian culture & history</p>
          </div>
